...
<head>
	<meta charset="UTF-8">
	<title>Encanto no paraiso</title>
...
<!-- imagens -->
	<div class="wrapper-img">
		<div class="imagens">
			<img class="imagen"src="img/imfinicio.webp" alt="Descrição da imagem" loading="eager">
		</div>
	</div>
<!-- fim imagens  -->
<!-- sobre -->
	<section id="quadradainteira" class="fade-in">
		<div id="quadrado">

			<div id="sobre">
				<h2> Sobre nossa localização</h2>
			</div>

			<div id="texto">

				<p>Estamos em São Vendelino, um verdadeiro paraíso no coração da Serra Gaúcha. Nossa localização é estratégica e encantadora: a apenas 30 km do Vale dos Vinhedos, 90 km da capital Porto Alegre e a cerca de 90 km de Gramado. Um destino perfeito para quem busca descanso, conforto e contato com a natureza, sem abrir mão da facilidade de acesso.
				<br>Nossa cabana esta situada em uma propriedade privada, cercada por muito verde sendo abraçada pelas montanhas e o som relaxante da natureza, trazendo conforto — um convite diário à tranquilidade e ao bem-estar.
				<br>A cabana foi pensada nos mínimos detalhes para proporcionar conforto e sofisticação. Você encontrará:
				<br>Cozinha completa com fogão, e uma lareira para aquecer o ambiente no inverno enquanto degusta seu delicioso vinho da nossa querida serra gaúcha. 
				Venha viver momentos únicos em um lugar onde o sossego se encontra com a natureza. Estamos te esperando!</p>
			</div>
		</div>
	</section>
<!-- fim sobre  -->		
